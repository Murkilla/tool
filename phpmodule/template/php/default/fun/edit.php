                                    ...
                                    <form data-act="<?php echo $this->config->default_main;?>/<?php echo $this->io->input["get"]["fun"];?>/update" enctype="multipart/form-data" id="form_sample_3" method="post" class="form-horizontal">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="fid"  class="form-control" value="<?php echo $this->tplVar['table']['record'][0]['fid'];?>" readonly/> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-md-3">
                                            ...
                                            <input type='hidden' name="fid" id="fid" value="<?php echo $this->tplVar["table"]["record"][0]["fid"];?>"/>
                                            <input type="hidden" name="location_url" id="location_url" value="<?php echo $this->config->default_main;?>/fun"/>
                                        </div>
