                                    ...
                                    <form data-act="<?php echo $this->config->default_main;?>/<?php echo $this->io->input["get"]["fun"];?>/update" enctype="multipart/form-data" id="form_sample_3" method="post" class="form-horizontal">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="account"  class="form-control" value="<?php echo $this->tplVar['table']['record'][0]['account'];?>" readonly/> 
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-md-3">名稱
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3">存取權限
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-4">
                                                    <select class="form-control select2me" name="role">
                                                        <option value="">Select...</option>
                                                        <?php if(!empty($this->tplVar["table"]['rt']['role'])):?>
                                                            <?php foreach($this->tplVar['table']['rt']['role'] as $k => $v):?>
                                                                <option value="<?php echo $v['rid'];?>" <?php echo ($v['rid'] == $this->tplVar['table']['record'][0]['rid']) ? 'selected' : '';?>><?php echo $v['name'];?></option>
                                                            <?php endforeach;?>
                                                        <?php endif;?>
                                                    </select>
                                                    <span class="help-block"> 不修改密碼，以下留空 </span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="password" name="password" data-required="2" value="" class="form-control" placeholder="新密碼"/>
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="control-label col-md-3">密碼確認</label>
                                                <div class="col-md-4">
                                                    <input type="password" name="password_2" data-required="2" value="" class="form-control" placeholder="新密碼確認"/>
                                                </div>
                                            </div>
                                            <input type='hidden' name="uid" id="uid" value="<?php echo $this->tplVar["table"]["record"][0]["uid"];?>"/>
                                            <input type="hidden" name="location_url" id="location_url" value="<?php echo $this->config->default_main;?>/member"/>
                                        </div>
